...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 13; MHE, \S 3.1--3.2.
    \item \textit{Further reading}: CCI, ch.\ 6; ISL, ch.\ 3.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 15; MHE, ch.\ 8.
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Ward and Ahlquist, ch.\ 1--2 and 4.
    \item \textit{Further reading}: Pawitan, ch.\ 2--4.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 14; CCI, ch.\ 5; Stuart, Elizabeth A. 2010. ``Matching Methods for Causal Inference: A Review and a Look Forward.'' \textit{Statistical Science} 25(1), 1--21.
    \item \textit{Further reading}: CCI, ch.\ 4, 7, and 8; King, Gary and Richard Nielsen. 2019. ``Why Propensity Scores Should Not Be Used for Matching.'' \textit{Political Analysis} 27(4), 435--454.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 19; MHE, \S 4.1 and \S 4.4 (the latter is where LATE and the compliance types live); Angrist, Joshua D., Guido W. Imbens, and Donald B. Rubin. 1996. ``Identification of Causal Effects Using Instrumental Variables.'' \textit{Journal of the American Statistical Association} 91(434), 444--455.
    \item \textit{Further reading}: CCI, ch.\ 9; Lee, David S., Justin McCrary, Marcelo J. Moreira, and Jack Porter. 2022. ``Valid $t$-ratio Inference for IV.'' \textit{American Economic Review} 112(10), 3260--3290.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 20; Cattaneo, Matias D. and Roc\'{i}o Titiunik. 2022. ``Regression Discontinuity Designs.'' \textit{Annual Review of Economics} 14, 821--851.
    \item \textit{Further reading}: MHE, ch.\ 6; McCrary, Justin. 2008. ``Manipulation of the Running Variable in the Regression Discontinuity Design: A Density Test.'' \textit{Journal of Econometrics} 142(2), 698--714.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, ch.\ 16 and 18; Roth, Jonathan, Pedro H.C. Sant'Anna, Alyssa Bilinski, and John Poe. 2023. ``What's Trending in Difference-in-Differences? A Synthesis of the Recent Econometrics Literature.'' \textit{Journal of Econometrics} 235(2), 2218--2244.
    \item \textit{Further reading}: MHE, ch.\ 5; CCI, ch.\ 11; Goodman-Bacon, Andrew. 2021. ``Difference-in-Differences with Variation in Treatment Timing.'' \textit{Journal of Econometrics} 225(2), 254--277.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Athey, Susan and Guido W. Imbens. 2017. ``The State of Applied Econometrics: Causality and Policy Evaluation.'' \textit{Journal of Economic Perspectives} 31(2), 3--32; CML, ch.\ 4.
    \item \textit{Further reading}: CML, ch.\ 10; Wager, Stefan and Susan Athey. 2018. ``Estimation and Inference of Heterogeneous Treatment Effects Using Random Forests.'' \textit{Journal of the American Statistical Association} 113(523), 1228--1242.
\end{itemize}
