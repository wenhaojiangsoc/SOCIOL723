...
\textit{in the order you should read them}: the first builds the intuition, and those that follow supply the rigour. \textit{Further reading} is there for depth and for your own research; it is not examined.
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, Chapter 13; MHE, \S 3.1--3.2.
...
\begin{itemize}[noitemsep, topsep=2pt]
    \item \textit{Reading}: Effect, Chapter 15; MHE, Chapter 8.
