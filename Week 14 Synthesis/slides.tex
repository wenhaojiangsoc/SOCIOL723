...
\subtitle{Week 14, Synthesis and Exam Review\\[-6pt]}
...
\textbf{Cumulative final exam}: date and time TBD, set by class poll.
\end{block}
\end{frame}
...
\begin{frame}{Three Questions, in Order\core}
...
\begin{frame}[allowframebreaks,t]{Every Design, in One Table\core}
...
\begin{frame}[allowframebreaks,t]{Inference, in One Table\core}
\begin{center}\footnotesize
\renewcommand{\arraystretch}{1.25}
\begin{tabular}{lll}
\toprule
...
\begin{frame}{A Decision Guide\core}
...
\begin{frame}{Things That Are Never a Solution\core}
\begin{itemize}\itemsep3pt
...
\vskip4pt
\begin{itemize}\itemsep3pt
  \item \textbf{Everything developed in scalar form is examinable.} Frames
        marked \core{} are the essential spine, study those first. Frames
        marked \adv{} are not examinable: matrix derivations, projection
        geometry, asymptotic arguments.
...
\begin{block}{Logistics}
Date and time \textbf{to be determined}: we will poll the class and announce
well in advance. Open book and open note, but \textbf{timed}. The exam counts
35\%, or 25\% if you elected the \textbf{project option}, in which case your
6--10 page project memo and replication code are due Friday, December 11.
\end{block}
\vskip5pt
...
\begin{enumerate}\itemsep4pt
  \item \textbf{Work the blue stars.} Go deck by deck through the frames marked
        \core{} and check you can explain and use each one without notes. If you
        can, you are ready.
