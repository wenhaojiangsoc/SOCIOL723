...
averages over its possible values; Newton does the rest.
...
\begin{enumerate}\itemsep3pt
  ...
  \item \textbf{A group-level variable is the question.} School sector,
        neighborhood collective efficacy, a country's bargaining coverage.
        Fixed effects absorb it.
  \item \textbf{A within-group effect is the question and $u_j$ may
        correlate with $x$.} On HSB it does: $\hat u_j$ correlate $0.51$
        with school-mean SES, and the slope drifts from the within-school
        $2.19$ to $2.38$. Use fixed effects, or add the group mean of $x$
        \srcp{Mundlak 1978; Bell and Jones 2015}: SES $2.19$ ($0.11$),
        the fixed-effects number; school-mean SES $3.14$ ($0.38$);
        Catholic $1.23$ ($0.30$), still estimable.
\end{enumerate}
\end{frame}
...
\begin{itemize}\itemsep3pt
  ...
  \item A coefficient is the log-odds change holding the school's $u_j$
        fixed. For a population-average probability, average predictions
        over $u_j$; the logit's curve makes the two differ.
...
2nd ed. Sage.
\item Bell, Andrew and Kelvyn Jones. 2015. ``Explaining Fixed Effects: Random
Effects Modeling of Time-Series Cross-Sectional and Panel Data.''
\textit{Political Science Research and Methods} 3(1): 133--153.
...
\item Mundlak, Yair. 1978. ``On the Pooling of Time Series and Cross Section
