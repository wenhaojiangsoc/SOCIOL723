...
twice the OLS one.
\end{alertblock}
\textbf{The bonus.} Name the shared part $u_j$ and its variance is a
parameter: how much variation is between schools ($18\%$ here), the question
Coleman et al.\ (1966) made famous.
\end{frame}
