...
\end{block}
\begin{itemize}\itemsep2pt
  \item The candidate fits $\X b$ form a plane, and ``closest point on a
        plane'' is a problem geometry solved long before calculus:
        \alert{the foot of the perpendicular}.
