...
\vskip1pt
{\footnotesize Note the hats: we premultiplied the \emph{fitted} equation,
true in every sample, not the model. The middle display also shows that the
short regression's residual is $\ehat$ itself, the theorem's second claim.}
\end{frame}
