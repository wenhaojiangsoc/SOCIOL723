...
\begin{frame}[allowframebreaks,t]{Decomposing Prediction Error}
...
\begin{frame}[allowframebreaks,t]{Estimating Test Error: Cross-Validation}
...
\begin{frame}[allowframebreaks,t]{Ridge Regression}
...
\begin{frame}[allowframebreaks,t]{Regression Trees}
...
\begin{frame}[allowframebreaks,t]{What ML Buys, and What It Does Not}
\begin{columns}[T]
