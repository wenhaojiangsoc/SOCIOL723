...
\begin{frame}[allowframebreaks,t]{Setup and Identification}
...
\end{itemize}
\end{frame}
\begin{frame}[allowframebreaks,t]{Why the Optimal Bandwidth Breaks the Confidence Interval}
...
\begin{frame}[allowframebreaks,t]{Fuzzy RD Inherits Everything From IV}
\begin{itemize}\itemsep3pt
