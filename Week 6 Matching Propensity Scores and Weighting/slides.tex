...
\subtitle{Week 6, Matching, Propensity Scores, and Weighting\\[-6pt]}
...
\begin{frame}{Cell-by-Cell Comparison\core}
...
\begin{frame}{Anatomy of Regression Adjustment: Setup\adv}
...
\begin{frame}{Anatomy of Regression Adjustment: the Numerator\adv}
...
\begin{frame}{The Idea, in Its Simplest Form\core}
...
\begin{frame}[allowframebreaks,t]{The Curse of Dimensionality\core}
...
\begin{frame}{Matching Is Preprocessing, Not Estimation\core}
...
\begin{frame}{A Remarkable Theorem\core}
...
\begin{frame}{Estimating and Checking It\core}
\begin{itemize}\itemsep3pt
...
\begin{frame}{Overlap: What to Do When It Fails\core}
\begin{center}
...
\begin{frame}{Inverse Probability Weighting\core}
...
\begin{frame}[allowframebreaks,t]{One Class of Estimands, Three Members\adv}
...
\begin{frame}[allowframebreaks,t]{Weighting to Different Estimands\core}
...
\begin{frame}[allowframebreaks,t]{G-Computation: the Other Half\core}
...
\begin{frame}{Case 1: the Outcome Model Is Correct\adv}
...
\begin{frame}{Case 2: the Propensity Score Is Correct\adv}
...
\begin{frame}{An Honest Warning\core}
...
\begin{frame}{Sensitivity Analysis: Taking the Assumption Seriously\core}
...
Assigned today, due Monday October 19, the Monday \emph{after} the midterm
week, so it does not compete with exam preparation. Covers Weeks 5--6.
\end{block}
\end{frame}
