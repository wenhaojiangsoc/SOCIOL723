...
\begin{frame}[allowframebreaks,t]{The Factor-Model Justification}
...
\begin{frame}[allowframebreaks,t]{Inference With One Treated Unit}
...
\end{itemize}
\end{frame}
\begin{frame}[allowframebreaks,t]{Placebo Inference, Mechanically}
