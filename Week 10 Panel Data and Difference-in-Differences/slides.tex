...
\begin{frame}[allowframebreaks,t]{The Within Transformation, Explicitly}
...
\begin{frame}[allowframebreaks,t]{Parallel Trends}
...
\end{itemize}
\end{frame}
\begin{frame}[allowframebreaks,t]{Parallel Trends Is Not Scale-Free}
...
\begin{frame}[allowframebreaks,t]{Negative Weights}
